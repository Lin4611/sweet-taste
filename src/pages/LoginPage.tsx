...
const LoginPage: FC = () => {
  return (
    <>
      <main className="w-full mx-auto lg:max-w-[1024px] lg:py-[75px] md:py-[75px]">
        {/* 手機板排版 */}
        <section className="flex justify-center items-center w-full gap-[30px] bg-primary/100 md:hidden lg:hidden">
        ...
        {/* 電腦排版 */}
        <section className="hidden lg:flex md:flex w-full items-center px-[122px]">
          <section className="w-full max-w-[390px] h-[380px] flex flex-col items-center justify-between bg-primary">
            <h2 className="leading-9 font-semibold text-4xl text-invert my-10">
              會員登入
            </h2>
            <section className="w-full flex flex-col gap-4 px-[30px] mb-[25px]">
              <div className="relative w-full ">
                <img
                  src={account_icon}
                  alt="account"
                ...
                <input
                  type="text"
                  placeholder="電子信箱／手機號碼"
                  className="w-full h-14 bg-invert/100 pl-16 text-primary placeholder:text-muted focus:outline-none focus:ring-0"
                />
              </div>
              <div className="relative w-full ">
                <img
          ...
          <section className="flex flex-col items-center w-full py-10 bg-soft/100 justify-between gap-12">
            <h2 className="text-title text-muted leading-9">—— 連結社群帳號 ——</h2>
            <div className="w-full flex flex-col gap-4 px-[30px]">
              <button
                type="button"
                className="flex justify-center items-center max-w-[330px] w-full h-[56px] bg-invert hover:bg-accent"
              >
                <img
                  src={facebook_logo}
                  alt="facebook登入"
                  className="maxw-h-[31px] w-[108px] object-cover"
                />
              </button>
              <button
                type="button"
                className="flex justify-center items-center w-full max-w-[330px] h-[56px] bg-invert hover:bg-accent"
              >
                <img
                  src={google_logo}
                  alt="google登入"
                  className="max-h-[31px] w-auto object-cover"
                />
              </button>
              <button
                type="button"
              ...
              >
                <img
                  src={yahoo_logo}
                  alt="yahoo登入"
                  className="max-h-[31px] w-[96px] object-cover"
                />
              </button>
            </div>
          </section>
