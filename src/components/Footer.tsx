...
const Footer = () => {
  return (
    <footer className="max-w-[375px] w-full mx-auto flex flex-col py-[34px]">
      <section className="w-full flex flex-col bg-primary h-[186px] py-[30px] items-center justify-between">
        ...
        <div className="flex w-full items-center h-14 relative px-[30px]">
          <img src={mail_icon} alt="" className="z-100 w-6 h-6 object-cover absolute left-[50px]" />
          <input type="email" className="bg-soft h-full w-[251px] focus:outline-none focus:ring-0 pl-16" />
